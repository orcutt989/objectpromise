...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function generateUsername() {
        const adjectives = ["Absolute", "Abstract", "Abyssal", "Adorable", "Adventurous", "Angry", "Agreeable", "Awful", "Bad", "Basic", "Based", "Better", "Billionaire", "Bizarre", "Blushing", "Bored", "Brave", "Charming", "Cheeky", "Cheerful", "Clever", "Curious", "Dank", "Dark", "Defiant", "Dizzy", "Eager", "Embarrassed", "Energetic", "Excited", "Famous", "Fierce", "Filthy", "Foolish", "Friendly", "Funny", "Glamorous", "Gnarly", "Goofy", "Groovy", "Grumpy", "Helpful", "Hilarious", "Hungry", "Imaginary", "Important", "Innocent", "Itchy", "Jealous", "Jolly", "Juicy", "Lethal", "Lively", "Lovely", "Lucky", "Memetic", "Moist", "Mushy", "Nasty", "Orbular", "Outgoing", "Perfect", "Powerful", "Prickly", "Puzzled", "Quirky", "Relativistic", "Rusty", "Salty", "Scary", "Scrumptuous", "Shiny", "Silly", "Sloppy", "Super", "Tasty", "Toasty", "Unusual", "Victorious", "Witty", "Zealous"];
        const nouns = ["Abacus", "Adventure", "Anarchoegoist", "Android", "Anticapitalist", "Battlepass", "Bean", "Berserker", "Bingus", "Blender", "Brandon", "Bread", "Carrot", "Cat", "Cloud", "Clummster", "Coffee", "Company", "Comrade", "Cookie", "Crab", "Crane", "Creed", "Cyborg", "Dentist", "Dirt", "Dongle", "Dragon", "Egg", "Entity", "Fairy", "Flamingo", "Fork", "Fossil", "Frog", "Fungus", "Gamer", "Gender", "Goblin", "Grindset", "Herb", "Hippie", "Humbler", "Illusion", "Jellyfish", "Joker", "Kangaroo", "Ketchup", "Koala", "Kolache", "Laborer", "Landmine", "Lemonade", "Lumpenprole", "Mascot", "Mayonnaise", "Meme", "Monk", "Ninja", "Noodle", "Obelisk", "Object", "Orb", "Outlaw", "Panda", "Paperclip", "Pierogi", "Pizza", "Potion", "Promise", "Q-tip", "Rebel", "Rizzler", "Robot", "Sauce", "Socialist", "Slug", "Soda", "Soup", "Spoon", "Stinker", "Taco", "Theory", "Toast", "Tornado", "Troll", "Unit", "Villager", "Virus", "Wiggler", "Wickhead", "Wizard", "Xenomorph", "Zebra"];
